...
# 本地端測試
# 1. 開啟ngrok : ./ngrok http 5001
# 2. 把測試網址更新到Line 後台的 Webhook URL
...
def handle_message(event):
    with ApiClient(configuration) as api_client:
        ...
        print("#" * 30)
        bot_msg = menu # TextMessage(text=f"你剛才說的是: {user_msg}")
        # 如果 user_msg 存在於faq字典內
        if user_msg in faq:
            # 將回復訊息改為faq字典內對應的訊息
        ...
        # if user_msg == 'hello':
            #bot_msg = TextMessage(text='你好, 我是機器人')
        # elif user_msg == '電話':
            #bot_msg = TextMessage(text='02-12345678')
        # elif user_msg == '地址':
            #bot_msg = LocationMessage(title='台大', address='臺北市大安區羅斯福路四段1號',latitude= 25.0145233, longitude=121.5353451)
        # elif user_msg == '貼圖':
            #bot_msg = StickerMessage(packageId='6359', stickerId='11069853')
